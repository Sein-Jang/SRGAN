...
class Trainer:
    ...
    def train(self, train_dataset, valid_dataset, steps, eval_every=2, save_best_only=False):
        loss_mean = Mean()
...
class GeneratorTrainer(Trainer):
    ...
    def train(self, train_dataset, valid_dataset, steps=1000000, eval_every=1000, save_best_only=True):
        super().train(train_dataset, valid_dataset, steps, eval_every, save_best_only)
...
class SrganTrainer:
    ...
    def train(self, train_dataset, steps=200000):
        ...
        for lr, hr in train_dataset.take(steps):
            ...
            if step % 50 == 0:
                print(f'{step}/{steps}, perceptual loss = {pl_metric.result():.4f}, discriminator loss = {dl_metric.result():.4f}')
                pl_metric.reset_states()
                dl_metric.reset_states()
